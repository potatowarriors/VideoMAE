...
class EGO4DVideoClsDataset(Dataset):
     ...
     def __init__(self, anno_path, data_path, mode='train', clip_len=8,
          ...
          task_col = 1 if self.task == "verb" else 2   #! 1 is verb and 2 is noun
          self.label_array = list(cleaned.values[:, task_col]) 
     ...
     def __getitem__(self, index):
          if self.mode == 'train':
               ...
               sample = self.dataset_samples[index] + '.mp4' #! Set file name.
               sample = os.path.join(self.data_path, sample) #! Set file pull path.
