...
def main(args, ds_init):
    ...
    model, unfreeze_list = unfreeze_block(model, ['cross', 'clip_space_time_pos', 'clip_time_pos', 'vmae_time_pos', 'vmae_space_time_pos','Adapter', 'ln_post', 'vmae_fc_norm','last_proj','head'])
